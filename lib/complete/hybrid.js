...
export function analyzeCompletion(state, node) {
    ...
    switch (node.type.id) {
        ...
        case Identifier:
            ...
            if (((_a = node.parent) === null || _a === void 0 ? void 0 : _a.type.id) === 0) {
            }
            ...
            const parent = (_d = (_c = (_b = node.parent) === null || _b === void 0 ? void 0 : _b.parent) === null || _c === void 0 ? void 0 : _c.parent) === null || _d === void 0 ? void 0 : _d.parent;
            if (!parent) {
