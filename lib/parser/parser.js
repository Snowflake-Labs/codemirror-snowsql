import { CreateExpr, DescribeExpr, DropExpr, And, BinModifiers, Bool, Eql, Expr, Gte, Gtr, Mul, Identifier, Lss, Lte, Neq, Or, ParenExpr, SubqueryExpr, 
//Unless,
SelectExpr, Comma, Smc, From, } from 'lezer-snowsql';
import { containsAtLeastOneChild, walkThrough } from './path-finder';
...
export class Parser {
    ...
    checkSelect(node) {
        ...
        if (((_e = fromChild === null || fromChild === void 0 ? void 0 : fromChild.prevSibling) === null || _e === void 0 ? void 0 : _e.type.id) != Identifier) {
            if (((_f = fromChild === null || fromChild === void 0 ? void 0 : fromChild.prevSibling) === null || _f === void 0 ? void 0 : _f.type.id) != Mul) {
